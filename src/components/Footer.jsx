    ...
    <div className="w-full mt-24 bg-slate-900 text-gray-300 py-8 px-2">
      <div className="max-w-[1240px] mx-auto grid grid-cols-2 md:grid-cols-6 border-b-2 border-gray-600 py-8">
        ...
        <div className="col-span-2 pt-8 md:pt-2">
          <p className="font-bold uppercase ">Subscribe to news letter</p>
          <p className="py-4">
      ...
      <div className="flex flex-col max-w-[1240px] m-auto justify-between sm:flex-row text-center text-gray-500">
        <p className="py-4">
          {new Date().getFullYear()} Workflow, LLC. All rights reserved
        </p>
        <div className="flex justify-between sm:w-[300px] pt-4 text-2xl px-2 py-4">
          <FaFacebook />
          <FaInstagram />
          <FaTwitter />
          <FaTwitch />
